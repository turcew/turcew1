export const campaign = {
    ...
    methods:{
        ...
        delAd:async function () {
            if(await this.$refs.header.$refs.msg.confirmFun("Please confim next action","Do you want to delete this banner?")){
                var self = this;
                var data = self.parent.toFormData(self.parent.formData);
        ...
        <div class="panelTop">
            ...
            <popup ref="chart" fullscreen="true" title="Chart">
                <div class="flex panel">
                    <div class="w30 ptb25"><input type="date" v-model="date" @change="get();" /> - <input type="date" v-model="date2" @change="getCampaignBannersChart();" /></div>
                    <div class="w70 al">
